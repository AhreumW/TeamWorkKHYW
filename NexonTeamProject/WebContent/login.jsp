...
<body>
	...
	<div id="wrapper" style="width:440px; clear:both; margin:0px auto;">
		<h1 style="width:440px; height:126px; padding-top: 98px; box-sizing:border-box; font-weight:normal; font-size: 30px; ">로그인</h1>
		<div id="choLoginBox" style="border-bottom: 1px solid #cbcbcb; width:440px; height:44px;">
			...
			<div style=" box-sizing:border-box; margin-left:19px; text-align:center; float: left; width: 140px; height:44px; background-color: #F4F4F4;padding-top: 10px; border-top: 1px solid #cbcbcb; border-left: 1px solid #cbcbcb; border-right: 1px solid #cbcbcb;">
		...
		<div id="inputBox" style="clear: both; width: 440px; height: 207px;">
			<input type="checkbox"><span style="font:12px Dotum;">넥슨ID 저장</span>
			<div style="width: 440px; height:61px; padding: 6px 0px 0px 7px;">		
				<input type="text" placeholder="넥슨ID(아이디 또는 이메일)를 입력해주세요." style="width:412px; height: 39px;font-size:16px; padding: 12px 0px 9px 10px;">
			</div>
			<div style="width: 440px; height:61px; padding: 6px 0px 0px 7px;">
				<input type="password" placeholder="비밀번호를 입력해주세요." style="width:412px; height: 39px;font-size:16px; padding: 12px 0px 9px 10px;">
			</div>
		</div>
		...
		<div style="width:440px; heigth:78px; padding: 25px 0px 37px;">
			<span style="font:12px Dotum; color:#777777; padding: 0px 1px 0px 3px; border-right:1px solid #D9D9DA;">넥슨ID 찾기</span>
			<span style="font:12px Dotum; color:#777777; padding: 0px 1px 0px 3px; border-right:1px solid #D9D9DA;">비밀번호 찾기</span>
			<span style="font:12px Dotum; color:#777777; padding: 0px 1px 0px 3px;">넥슨 회원가입</span>
			<span style="font:12px Dotum; color:#777777; padding: 0px 1px 0px 3px;">보안센터</span>
		</div>
	</div>
</body>
</html>